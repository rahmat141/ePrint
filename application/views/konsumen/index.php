        ...
        <div class="rev_slider fullscreenbanner" id="home-banner">
            <ul>
                <li class="ps-banner" data-index="rs-2972" data-transition="random" data-slotamount="default"
                    data-hideafterloop="0" data-hideslideonmobile="off" data-rotate="0"><img class="rev-slidebg" src="<?= base_url(
                        'assetsKonsumen/'
                    ) ?>images/slider/3.jpg" alt="" data-bgposition="center center" data-bgfit="cover"
                ...
                <li class="ps-banner ps-banner--white" data-index="rs-100" data-transition="random"
                    data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-rotate="0"><img
                        class="rev-slidebg" src="<?= base_url(
                            'assetsKonsumen/'
                        ) ?>images/slider/2.jpg" alt="" data-bgposition="center center" data-bgfit="cover"
                        data-bgrepeat="no-repeat" data-bgparallax="5" data-no-retina>
                            ...
                            <div class="grid-item__content-wrapper">
                                <div class="ps-shoe mb-30">
                                    <div class="ps-shoe__thumbnail">
                                        ...
                                        <img src="<?= base_url(
                                            'assetsKonsumen/'
                                        ) ?>images/product/<?= $pst->gambar ?>" alt=""><a class="ps-shoe__overlay"
                                            href="<?= base_url(
                                                'Konsumen/detail/'
                                            ) . $pst->id_posting ?>"></a>
                                    </div>
                                    <div class="ps-shoe__content">
                                        <div class="ps-shoe__variants">
                                            <div class="ps-shoe__variant normal">
                                                ...
                                                <img src="<?php echo base_url(); ?>assetsKonsumen/images/shoe/3.jpg"
                                                    alt="">
                        ...
                        <div class="ps-shoe">
                            <div class="ps-shoe__thumbnail">
                                <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite" href="#"><i
                                        class="ps-icon-heart"></i></a><img src="<?= base_url(
                                            'assetsKonsumen/'
                                        ) ?>images/shoe/1.jpg" alt=""><a class="ps-shoe__overlay"
